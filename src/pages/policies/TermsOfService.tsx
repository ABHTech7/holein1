              ...
              <div className="space-y-8">
                <section>
                  ...
                  <p className="text-foreground mb-4">
                    By accessing and using Official Hole In 1, you accept and agree to be bound by the terms 
                ...
                <section>
                  ...
                  <p className="text-foreground mb-4">
                    Permission is granted to temporarily use Official Hole In 1 for personal, non-commercial 
                ...
                <section>
                  ...
                  <p className="text-foreground mb-4">
                    You may not use Official Hole In 1 for any unlawful purpose or to solicit others to 
                ...
                <section>
                  ...
                  <p className="text-foreground mb-4">
                    Official Hole In 1 shall not be liable for any damages arising from the use or inability 
                    to use the platform.
                  </p>
                </section>
