-- Create RPC to get paginated insurance entries data
...
RETURNS TABLE(competition_name text, entry_date timestamp with time zone, player_first_name text, player_last_name text)
LANGUAGE plpgsql
SECURITY DEFINER
