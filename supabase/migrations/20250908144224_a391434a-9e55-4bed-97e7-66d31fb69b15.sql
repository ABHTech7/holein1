...
-- Fix validate_club_data function
...
INSERT INTO public.audit_events (
  ...
  'SEARCH_PATH_SECURED',
  jsonb_build_object(
    'action', 'Fixed function search path security warnings',
    'functions_fixed', ARRAY['is_valid_email', 'is_valid_phone', 'validate_profile_data', 'validate_club_data'],
    'timestamp', now()
  ),
  auth.uid()
);