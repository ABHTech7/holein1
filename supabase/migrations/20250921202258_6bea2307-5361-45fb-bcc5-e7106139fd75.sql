-- Recreate function with proper permissions and make it accessible to all authenticated users
...
-- Grant permissions to authenticated users (will be checked by the function internally)
GRANT EXECUTE ON FUNCTION public.get_incomplete_players() TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_incomplete_players() TO anon;